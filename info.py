...
PICS = (environ.get('PICS', 'https://graph.org/file/5b65144967a1916dc4532.jpg')).split() #SAMPLE PIC
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1001980999524').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://KingKhan:KingKhan@cluster0.mmw7bw2.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001966224031'))
...
URL = "https://movie-yoz6.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://movie-yoz6.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://movie-yoz6.onrender.com/".format(FQDN)
else:
    URL = "https://movie-yoz6.onrender.com/".format(FQDN)
