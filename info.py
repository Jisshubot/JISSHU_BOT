...
URL = "https://jishan202.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://jishan202.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://jishan202.onrender.com/".format(FQDN)
else:
    URL = "https://jishan202.onrender.com/".format(FQDN)
