...
BOT_TOKEN = environ.get('BOT_TOKEN', "6632775595:AAENi80SLJswcXe1NbUQZd0m-dBUwRuQQvE")
...
URL = "https://movie-cehn.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://movie-cehn.onrender.com".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://movie-cehn.onrender.com".format(FQDN)
else:
    URL = "https://movie-cehn.onrender.com".format(FQDN)
